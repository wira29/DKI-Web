...
export const metadata: Metadata = {
  title: 'Berita',
  description: 'Berita terbaru seputar aktivitas, acara, dan informasi penting dari Digital Kompetensi Indonesia.',
};

export default async function NewsPage() {
  const newsData = await prisma.post.findMany({
    where: { type: 'BERITA' },
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-white/80 font-light leading-relaxed">
                Dapatkan kabar terbaru seputar kegiatan, pencapaian, dan informasi penting lainnya dari Digital Kompetensi Indonesia.
              </p>
            </div>
