              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 max-h-64 overflow-y-auto p-1 custom-scrollbar">
                {images.map((img) => (
                  <button
                    ...
                    className={`relative aspect-square rounded-xl overflow-hidden border-2 transition-all ${value === img ? 'border-black ring-2 ring-gray-200' : 'border-gray-100 hover:border-gray-300'}`}
                  >
